#!/usr/bin/env bash
# =============================================================================
# WORDPRESS VM — PROXMOX VE PROVISIONING SCRIPT  (v7 — production-ready)
# =============================================================================
#
...
check "MariaDB health"   "$(podman inspect mariadb --format '{{.State.Health.Status}}' 2>/dev/null)" "healthy"
...
# Port 80 listening
check "Port 80 listening"   "$(ss -tlnp 2>/dev/null | grep -c ':80 ' | tr -d ' ')" "1"
...
chk "Port 80 listening" "$(ss -tlnp 2>/dev/null | grep -c ':80 ' | tr -d ' ')" "1"
